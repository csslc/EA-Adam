...
parser.add_argument('--resume', type=str, default='/home/notebook/data/group/SunLingchen/code/SimpleIR-main/BasicSR_model/ESRGAN_PSNR_SRx4_DF2K_official-150ff491.pth', help = 'resume training or not')
