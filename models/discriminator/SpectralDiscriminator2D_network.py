...
import sys
sys.path.append('/home/notebook/data/group/SunLingchen/code/DualFormer-main')
...
def create_model(args):
    return SpectralDiscriminator2D(args)
...
#                 spec_type='power', scale='linear', reduction="none",
        ...
        self.version = 'swin'
        self.spec_type = 'power'
        self.scale = 'linear'
        self.reduction = "none"
        self.fix_normalize = False
        self.after_mean = False
        self.net = self.architectures[self.version](img_size, patch_size,
        num_classes=args['num_classes'], 
        embed_dim=args['embed_dim'],
        depths = args['depths'],
        num_heads=args['num_heads'],
        mlp_ratio=args['mlp_ratio'],
        fused_window_process=args['fused_window_process'],
        in_chans=3 if self.reduction=='none' else 1,window_size=window_size)
